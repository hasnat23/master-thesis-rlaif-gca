...
explanation did not. The GCA advantage observed at $n=1{,}000$ is therefore not
an artifact that would have appeared at any scale if only enough runs had been
collected; it is specific to the smaller dataset size, and it disappears, not
merely shrinks, once training data becomes more plentiful.

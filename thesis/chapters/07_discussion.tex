...
real, scale-dependent change, they should not. Six-run campaigns at both
$n=5{,}000$ and $n=10{,}000$, using the same corrected, deterministic training
procedure as the $n=1{,}000$ extension, now answer that question.

The result is unambiguous. At $n=5{,}000$, the mean gap across six runs is
$+0.02$ percentage points (95\% CI $[-0.44, +0.62]$pp, Wilcoxon $p=0.6875$); at
$n=10{,}000$, $-0.03$ percentage points (95\% CI $[-0.54, +0.42]$pp, $p=1.0000$).
...
0.5691 to roughly 0.585--0.586 at both $n=5{,}000$ and $n=10{,}000$), exactly

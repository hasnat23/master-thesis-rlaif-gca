...
construction encodes, and it was not tested in this thesis. It is recorded as
the leading candidate for future work (Chapter~\ref{ch:conclusion},
Section~\ref{sec:concl-future}), together with the concrete, low-cost test
that would confirm or refute it using checkpoints already trained for RQ4.

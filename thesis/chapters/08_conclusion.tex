...
advantage does not persist as the dataset grows: six-run campaigns at
$n=5{,}000$ and $n=10{,}000$, using the same corrected procedure, give mean gaps
of $+0.02$ and $-0.03$ percentage points respectively, both statistically
indistinguishable from zero (95\% CIs $[-0.44,+0.62]$ and $[-0.54,+0.42]$
points), with neither interval overlapping the significant $n=1{,}000$ result.
...
that does not cross zero. Six-run campaigns at $n=5{,}000$ and $n=10{,}000$
give mean gaps statistically indistinguishable from zero ($p=0.6875$ and
$p=1.0000$), with confidence intervals that do not overlap the $n=1{,}000$
...
six-run campaigns at $n=5{,}000$ and $n=10{,}000$ are similarly stable around a
mean of approximately zero (SD under 0.8 points at both scales). Across dataset
sizes, stability does not hold, and this is no longer an open question left by
single runs: six repeated runs at each of $n=5{,}000$ and $n=10{,}000$ confirm a

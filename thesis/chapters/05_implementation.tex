...
Every RQ1--RQ3 result (Chapter~\ref{ch:results}, Sections~\ref{sec:results-rm-baseline}
to~\ref{sec:results-effect-sizes}) uses $k$-fold cross-validation
...
(Chapter~\ref{ch:results}, Section~\ref{sec:results-final-campaign}),
...
Appendix~\ref{app:reproduction}. The original, unseeded behaviour is
...
(Chapter~\ref{ch:results}, Section~\ref{sec:results-final-campaign}) predates

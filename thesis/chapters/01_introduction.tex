...
\begin{enumerate}
  ...
  \item An independent, held-out ground-truth evaluation (RQ4) showing that the
    ...
    (Chapter~\ref{ch:results}, Section~\ref{sec:results-ground-truth}). A
    leading candidate explanation for the reversal was tested directly against
    the training data and rejected (Section~\ref{sec:results-gt-margin}).

...
\begin{enumerate}
  ...
  \item A repeated-run and multi-scale evaluation showing that GCA can improve
    preference learnability under some configurations, most clearly at
    $n=1{,}000$ with the AlignScore \texttt{nli} mode, and that the improvement
    diminishes at larger dataset sizes

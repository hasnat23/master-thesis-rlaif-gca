...
penalised relative to one that is uniformly mediocre but fabricates nothing, and
...
(Chapter~\ref{ch:results}, Section~\ref{sec:results-formula-opt}), and what
survives of the granularity question is narrower and more conditional than the
motivating intuition suggests.

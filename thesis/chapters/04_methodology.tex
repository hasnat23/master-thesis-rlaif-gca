...
GCA aggregation & Simple mean ($\alpha = 0.0$), $n=5{,}000$/$n=10{,}000$ only\footnotemark[\value{footnote}] \\
...
Chapter~\ref{ch:results}, Section~\ref{sec:results-rm-baseline}). A subsequent optimization campaign
...
(Chapter~\ref{ch:results}, Section~\ref{sec:results-final-campaign}). $\alpha = 0.0$ was accordingly locked
...
That last point requires a sharper qualification than an earlier version of
this section gave it. The ranking itself, the ground-truth criterion both
...
it is not, contrary to what this section previously claimed, a symmetric
